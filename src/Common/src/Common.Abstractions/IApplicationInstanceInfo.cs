...
namespace PhnTnTi.Common
{
    public interface IApplicationInstanceInfo
    {
        ...
        /// </summary>
        /// <param name="tntiComponent">The Steeltoe component requesting the app's name</param>
        /// <param name="additionalSearchPath">One additional config key to consider, used as top priority in search</param>
        /// <returns>The name of the application</returns>
        string ApplicationNameInContext(PhnTnTiComponent tntiComponent, string additionalSearchPath = null);
    }
}
