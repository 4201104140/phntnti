...
using PhnTnTi.Common.Configuration;
using PhnTnTi.Common.Options;
using System;
...
namespace PhnTnTi.Common
{
    public class ApplicationInstanceInfo : AbstractOptions, IApplicationInstanceInfo
    {
        ...
        public string ApplicationNameInContext(PhnTnTiComponent steeltoeComponent, string additionalSearchPath = null)
        {
            return steeltoeComponent switch
            {
                PhnTnTiComponent.Configuration => ConfigurationValuesHelper.GetPreferredSetting(configuration, DefaultAppName, additionalSearchPath, ConfigServerNameKey, PlatformNameKey, AppNameKey),
                PhnTnTiComponent.Discovery => ConfigurationValuesHelper.GetPreferredSetting(configuration, DefaultAppName, additionalSearchPath, EurekaInstanceNameKey, ConsulInstanceNameKey, PlatformNameKey, AppNameKey),
                PhnTnTiComponent.Kubernetes => ConfigurationValuesHelper.GetPreferredSetting(configuration, DefaultAppName, additionalSearchPath, KubernetesNameKey, PlatformNameKey, AppNameKey),
                PhnTnTiComponent.Management => ConfigurationValuesHelper.GetPreferredSetting(configuration, DefaultAppName, additionalSearchPath, ManagementNameKey, PlatformNameKey, AppNameKey),
